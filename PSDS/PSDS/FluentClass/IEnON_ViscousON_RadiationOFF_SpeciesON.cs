...
{
    //能量方程开启；湍流开启；辐射关闭；组分开启
    interface IEnON_ViscousON_RadiationOFF_SpeciesON
    {
        /// <summary>
        /// 设置速度入口边界条件
        /// </summary>
        ...
        string VI(string boundaryName, VelocityMethod velocityMethod, ReferenceFrame referenceFrame, string velocityMagnitude, string gaugePressure, TurbulenceSet turbulenceSet,string temperature,List<string> speciesMassFractions, float[] xyzDirctionOrComponent = null);
        ...
        /// <returns>TUI命令</returns>
        string PI(string boundaryName, ReferenceFrame referenceFrame, PI_DirectionMethond directionMethond, string guageTotalPressure, string guageInitialPressure, TurbulenceSet turbulenceSet, string temperature, List<string> speciesMassFractions, float[] xyzDirection = null);
        ...
        /// <returns>TUI命令</returns>
        string MI(string boundaryName, ReferenceFrame referenceFrame, MassFlowMethond massFlowMethond, PI_DirectionMethond dirctionMethond, string massFlowRateOrFlux, string initialGaugePress, TurbulenceSet turbulenceSet, string temperature, List<string> speciesMassFractions, string averageFlux = null, float[] xyzDirection = null);
        ...
        /// <returns>TUI命令</returns>
        string PO(string boundaryName, ReferenceFrame referenceFrame, BackflowDirectionMethond bfDirectionM, BackflowPressure bfPressure, string gaugePressure, PO_MomentumCheck isCheck, TurbulenceSet turbulenceSet, string temperature, List<string> speciesMassFractions, float[] xyzDirection = null, float[] massFlowParameter = null);
