...
{
    /// <summary>
    /// 能量关闭；湍流关闭（Inviscid,或Laminar）
    /// </summary>
    public interface IEnOFF_ViscousOFF
    {
        ...
        string VI(string boundaryName, VelocityMethod velocityMethod, ReferenceFrame referenceFrame, string velocityMagnitude, string gaugePressure, float[] xyzDirctionOrComponent = null);
        ...
        /// <returns>TUI命令</returns>
        string PI(string boundaryName, ReferenceFrame referenceFrame, PI_DirectionMethond directionMethond, string guageTotalPressure, string guageInitialPressure, float[] xyzDirection = null);
        ...
        /// <returns></returns>
        string MI(string boundaryName, ReferenceFrame referenceFrame,MassFlowMethond massFlowMethond,PI_DirectionMethond dirctionMethond,string massFlowRateOrFlux,string initialGaugePress,string averageFlux=null,float[] xyzDirection=null);
        ...
        /// <returns>TUI命令</returns>
        string PO(string boundaryName, ReferenceFrame referenceFrame,BackflowDirectionMethond bfDirectionM, BackflowPressure bfPressure, string gaugePressure,PO_MomentumCheck isCheck,float[] xyzDirection=null,float[] massFlowParameter = null);
